...
<div class="w-full flex flex-row relative z-999">
    <div class="hidden lg:block lg:w-[265px] bg-[#0D0E12] fixed z-50 right-0 top-0 h-dvh px-3 text-sm">
        ...
        <div class="py-5 h-[90%] overflow-y-auto flex flex-col gap-5" style="scrollbar-width: none;">
            ...
            <div class="dashboard">
                <div
                        class="flex justify-between flex-row-reverse cursor-pointer px-2 rounded-sm py-1.5 @if (Route::is('ecomm.*') ||
                ...
                <ul
                        class="my-1 pr-3 transition-all duration-500 overflow-hidden @if (Route::is('ecomm.*') ||
                                Route::is('ecomm.ecomms') ||
                                Route::is('ecomm.list') ||
                                Route::is('ecomm_category.index') ||
                                Route::is('ecomm_category.create') ||
                    ...
                    <li
                            class="flex flex-row items-center gap-2.5 mt-2.5 mb-2.5 pr-5 rounded-sm @if (Route::is('ecomm.create')) bg-gray-700 @endif">
                    ...
                    <li
                            class="flex flex-row items-center gap-2.5 mt-2.5 mb-2.5 pr-5 rounded-sm @if (Route::is('ecomm.ecomms')) bg-gray-700 @endif">
                        <span class="size-1 bg-white rounded-sm"></span>
                        <a href="" class="text-white py-1 block">
                            فروشگاه های
                            من</a>
            ...
            <div class="dashboard">
                ...
                <ul
                    ...
                    <li
                        ...
                        <span class="size-1 bg-white rounded-sm"></span>
                        <a href="{{ route('institute.create') }}" class="text-white py-1 block">ایجاد آموزشگاه
                            جدید
                        </a>
                    </li>
                    <li
                        ...
                        <span class="size-1 bg-white rounded-sm"></span>
                        <a href="{{ route('institute.institutes') }}" class="text-white py-1 block">لیست همه
                            آموزشگاه ها
                        </a>
                    </li>
                    <li
            ...
            <div class="dashboard">
                ...
                <ul
                    ...
                    <li
                        ...
                        <span class="size-1 bg-white rounded-sm"></span>
                        <a href="{{ route('pages.social_list') }}" class="text-white py-1 block"> لیست صفحه های
                            من
                        </a>
                    </li>
                    @if (in_array(1, $ids))
                ...
                <div class="dashboard">
                    ...
                    <ul
                        ...
                        <li
                            ...
                            <span class="size-1 bg-white rounded-sm"></span>
                            <a href="{{ route('m.home') }}" class="text-white py-1 block">
                                 خانه </a>
                        </li>
                    </ul>
                </div>
