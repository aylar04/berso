...
<body
    class="max-w-[1700px] mx-auto [&::-webkit-scrollbar]:w-2.5  [&::-webkit-scrollbar-thumb]:bg-gradient-to-t [&::-webkit-scrollbar-thumb]:from-[#233561] [&::-webkit-scrollbar-thumb]:via-[#1e40af] [&::-webkit-scrollbar-thumb]:to-[#38bdf8]  [&::-webkit-scrollbar-thumb]:rounded-full">
    <header class="w-full md:h-dvh relative">
        <img src="{{asset('storage/home/header.jpg')}}" class="w-full h-[90%]" alt=""/>

        <div class="w-full fixed top-0 right-0  flex justify-center items-center z-5">
            <div
                class="w-11/12 h-full flex justify-between items-center bg-(--white) section_shadow sm:px-4 px-2 sm:py-3 py-1.5 rounded-xl">
        ...
        <div
            class="w-11/12 lg:w-3/7 h-[400px] flex flex-col justify-center items-center absolute top-20 left-0 right-0 mx-auto text-center">
            <h1 class="text-2xl lg:text-[44px] font-bold text-(--dark-text) drop-shadow-lg">
                وب سایت اختصاصی برای
            </h1>
        ...
        <div
            class="w-11/12 grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5 mx-auto bg-(--bg-white) drop-shadow-lg rounded-xl lg:absolute bottom-10 right-0 left-0">
            <div
                class="bg-gray-100 flex justify-between items-center px-4 py-6 rounded-t-lg md:rounded-r-none lg:rounded-r-lg">
                <div>
                    <span class="text-(--dark-text) font-bold block">طراحی اختصاصی</span>
                    <span class="text-(--secondary-text) block text-sm">متناسب با نیاز شما</span>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="40" height="40">
                    ...
                    <g>
                        <path class="cls-1"
                            d="M40,10l6.3,23.5,23.5,6.3-23.5,6.3-6.3,23.5-6.3-23.5L10.5,39.8l23.5-6.3,6.3-23.5Z" />
                        <circle class="cls-2" cx="40" cy="40" r="39.5" />
                    </g>
                </svg>
            </div>
            <div class="bg-gray-100 flex justify-between items-center p-4">
                <div>
            ...
            <div class="bg-gray-100 flex justify-between items-center p-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="40" height="40">
                    ...
                    <g>
                        <circle class="cls-2" cx="40" cy="40" r="39.5" />
                        <path class="cls-1" d="M46.6,13.6l-23.2,29.8h14.9l-5,23.2,23.2-31.5h-14.9l5-21.5Z" />
                    </g>
                </svg>
            </div>
            <div class="bg-gray-100 flex justify-between items-center p-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="40" height="40">
                    ...
                    <g>
                        <circle class="cls-1" cx="40" cy="40" r="39.5" />
                        <g>
                            <path class="cls-1" d="M17,60.8v-37.2" />
                            <path class="cls-1" d="M16.2,60h47.1" />
                        </g>
                        <path class="cls-3" d="M23.6,50.1l9.9-11.6,9.9,6.6,16.6-19.9" />
                        <path class="cls-2" d="M53.4,25.2h6.6v6.6" />
                    </g>
                </svg>
            </div>
            <div
                class="bg-gray-100 flex justify-between items-center p-4 rounded-b-lg md:rounded-l-none lg:rounded-l-lg">
                <div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" width="40" height="40">
                    ...
                    <g>
                        ...
                        <g>
                            <path class="cls-1" d="M20.3,39.3v-6.6c0-11.6,8.3-18.2,19.9-18.2s19.9,6.6,19.9,18.2v6.6" />
                            <path class="cls-2"
                            ...
                            <path class="cls-1" d="M60,55.9c0,6.6-5,9.9-13.3,9.9" />
                        </g>
                    </g>
                </svg>
            </div>
    ...
    <main class="mt-20 flex flex-col gap-20 justify-start items-center">
        <!-- identify_vidio-start -->
        <section class="w-full flex justify-center">
            <div class="w-11/12 rounded-xl flex flex-col md:flex-row bg-blue-700">
                <div class="w-full md:w-1/2  md:h-[50vh] flex justify-center items-center p-4">
                    <div class="w-full  md:w-10/12 h-[200px] md:h-[250px] bg-(--bg-secondary) rounded-xl flex items-center justify-center">
                        <img class="rounded-xl" src="{{asset('storage/home/6-11.png')}}" alt="">
                    </div>
                </div>
                <div
                    class="w-full md:w-1/2 h-auto md:h-[50vh] flex flex-col justify-center items-center text-center p-6 md:p-0">
                    <span class="text-white font-bold mb-4 md:mb-6 text-sm md:text-base">معرفی گروه برسو</span>
                    <span class="text-white text-[20px] md:text-[24px] font-bold mb-3 md:mb-4">ما یک تیم خلاق و متعهد
                        هستیم</span>
                    <span class="text-white mb-1 md:mb-2 text-sm md:text-base">با ترکیبی از تخصص خلاقیت وتجربه راهکارهای
                        دیجیتال</span>
                    <span class="text-white text-sm md:text-base">موثر و ماندگار برای برند شما ایجاد میکنیم</span>
                    <div
                        class="w-[140px] h-[50px] bg-white flex items-center justify-center rounded-lg text-(--primary-blue) mt-4 cursor-pointer hover:bg-gray-100 transition-all">
        ...
        <section class="w-full flex items-center justify-center">
            <div
                class="w-11/12 h-full flex flex-col gap-3 items-center justify-center bg-(--cart-background) rounded-xl section_shadow py-7">
                <p class="font-bold text-lg text-[var(--light-blue)]">چرا Berso?</p>
                <p class="lg:text-2xl sm:text-xl text-lg font-bold mt-1">ارزش پیشنهادی ما</p>
                ...
                <div
                    ...
                    <div
                        class="xl:min-w-1/9 xl:w-1/9 lg:min-w-1/6 lg:w-1/6 sm:min-w-1/4 sm:w-1/4 min-w-11/24 w-11/24  h-full flex flex-col gap-3 justify-center items-center cart_shadow p-3 rounded-md">
        ...
        <section class="w-full flex items-center justify-center">
            <div
                ...
                <p class="text-sm text-white font-bold">صنعت تخصصی شما؟</p>
                <p class="text-[17px] text-white lg:text-3xl mt-1 text-xl text-center">برای چه کسب و کارهایی طراحی
                    میکنیم ؟</p>
                ...
                <div class="w-11/12 lg:h-47 sm:h-37 h-30 flex gap-5 mt-5 overflow-x-auto lg:justify-start">
                    <div class="xl:min-w-15/100 xl:w-16/100 lg:min-w-23/100 lg:w-23/100 sm:min-w-31/100 sm:w-31/100 min-w-48/100 w-48/100  h-full flex flex-col lg:gap-3 sm:gap-2 gap-1 justify-center items-center cart_shadow p-3 rounded-md bg-white">
                        ...
                        <p class="max-lg:text-sm max-sm:text-xs font-bold lg:mt-4 sm:mt-2 mt-1">کافه و رستوران ها</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">منوی آنلاین</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">مشتری بیشتر</p>
                    </div>
                    ...
                    <div class="xl:min-w-15/100 xl:w-16/100 lg:min-w-23/100 lg:w-23/100 sm:min-w-31/100 sm:w-31/100 min-w-48/100 w-48/100  h-full flex flex-col lg:gap-3 sm:gap-2 gap-1 justify-center items-center cart_shadow p-3 rounded-md bg-white">
                        ...
                        <p class="max-lg:text-sm max-sm:text-xs font-bold lg:mt-4 sm:mt-2 mt-1">طلا فروشان</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">فروش آنلاین و</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">حضوری</p>
                    </div>
                    ...
                    <div class="xl:min-w-15/100 xl:w-16/100 lg:min-w-23/100 lg:w-23/100 sm:min-w-31/100 sm:w-31/100 min-w-48/100 w-48/100  h-full flex flex-col lg:gap-3 sm:gap-2 gap-1 justify-center items-center cart_shadow p-3 rounded-md bg-white">
                        ...
                        <p class="max-lg:text-sm max-sm:text-xs font-bold lg:mt-4 sm:mt-2 mt-1">پزشکان</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">وبسایت مطب و</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">کلینیک ها</p>
                    </div>
                    ...
                    <div class="xl:min-w-15/100 xl:w-16/100 lg:min-w-23/100 lg:w-23/100 sm:min-w-31/100 sm:w-31/100 min-w-48/100 w-48/100  h-full flex flex-col lg:gap-3 sm:gap-2 gap-1 justify-center items-center cart_shadow p-3 rounded-md bg-white">
                        ...
                        <p class="max-lg:text-sm max-sm:text-xs font-bold lg:mt-4 sm:mt-2 mt-1">وکلا</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">وبسایت اختصاصی برای</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">دفاتر حقوقی</p>
                    </div>
                    ...
                    <div class="xl:min-w-15/100 xl:w-16/100 lg:min-w-23/100 lg:w-23/100 sm:min-w-31/100 sm:w-31/100 min-w-48/100 w-48/100  h-full flex flex-col lg:gap-3 sm:gap-2 gap-1 justify-center items-center cart_shadow p-3 rounded-md bg-white">
                        ...
                        <p class="max-lg:text-sm max-sm:text-xs font-bold lg:mt-4 sm:mt-2 mt-1">معلمان</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">وبسایت آموزشی و</p>
                        <p class="lg:text-xs sm:text-[10px] text-[7px]">دوره های آنلاین</p>
                    </div>
                ...
                <div
                    class="w-11/12 flex flex-col lg:flex-row lg:justify-between items-center rounded-lg bg-[#2563EB] lg:p-5 p-2 mt-5 gap-3">
                    <div class="hidden lg:block w-12">
                    ...
                    <div class="w-full flex flex-col text-white text-center lg:mr-40 gap-2 lg:w-200 ">
                        <p class="text-sm xl:text-lg">شغل خودتو نتونستی پیدا کنی؟</p>
                        <p class="text-sm xl:text-sm hidden lg:block">ما برای هر کسب و کاری وبسایت اختصاصی طراحی میکنیم
                        </p>
                    </div>
                    <div class="bg-white rounded-md flex items-center justify-center text-[#2563EB] p-3 gap-3 py-5">
                        <p class="w-40 font-bold text-xs xl:text-md">مشاهده همه کسب و کار ها</p>
        ...
        <section class="w-full flex items-center justify-center">
            <div class="w-11/12 h-6/12 project flex flex-col items-center py-3 gap-5">
                <h2 class="text-blue-400">نمونه کار ها</h2>
                <span class="font-bold text-2xl">برخی از پرژه های اخیر ما</span>
                <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full gap-3">
                    <div
                        class="relative w-full flex justify-center h-85 group bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:border-yellow-400/30 hover:shadow-[0_20px_60px_rgba(255,193,7,0.08)] shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
            ...
            <div class="w-11/12 relative bg-[url({{asset('storage/home/coment.png')}})] bg-cover bg-center rounded-xl">
                ...
                <div class=" flex flex-col gap-4 w-full h-full items-center top-0 py-7 justify-between">
                    ...
                    <div
                        ...
                        <div
                            class="lg:w-1/3 w-full flex flex-col justify-between py-6 pt-11 xl:px-7 lg:px-4 px-5 gap-3 rounded-md bg-white">
                            <div class="flex justify-between">
                                <div class="w-1/6"></div>
                                <div class="w-4/6 flex justify-center">
                                    <p class="w-10/12">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعتصن عتصنعت
                                        چاپ و با از</p>
                                </div>
                                <div class="w-1/6 flex justify-end relative">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                        class="size-10 fill-blue-700 absolute -top-3">
                                        <path
                            ...
                            <div class="flex items-center gap-10">
                                <div
                                    class="xl:min-w-20 xl:max-w-20 xl:h-20 lg:min-w-17 lg:max-w-17 min-w-15 max-w-15 h-15 lg:h-17  flex justify-center items-center">
                                    <img class="w-full h-full rounded-full object-cover "
                                        src="{{asset('storage/home/IMG_20260626_161954.png')}}" alt="">
                                </div>
                                <div class="flex flex-col gap-2">
                                    <span class="font-bold lg:text-lg xl:text-xl text-nowrap"> علی رستمی</span>
                                    <span>مدیر کل طلا و جواهر</span>
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <div class="flex justify-between">
                                <div class="w-1/6"></div>
                                <div class="w-4/6">
                                    <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با از</p>
                                </div>
                                <div class="w-1/6 flex justify-end relative">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
                                        class="size-10 fill-blue-700 absolute -top-3">
                            ...
                            <div class="flex items-center gap-10">
                                <div
                                    class="xl:min-w-20 xl:max-w-20 xl:h-20 lg:min-w-17 lg:max-w-17 lg:h-17 min-w-15 max-w-15 h-15 flex justify-center items-center">
                                    <img class="w-full h-full rounded-full object-cover "
                                        src="{{asset('storage/home/IMG_20260626_161954.png')}}" alt="">
                                </div>
                                <div class="flex flex-col gap-2">
        ...
        <section class="w-full flex items-center justify-center">
            <div
                ...
                <div
                    class="max-w-full min-w-full xl:h-64 lg:h-51 md:h-43 sm:h-40 h-33 flex xl:gap-9 lg:gap-4 gap-3 items-center justify-start xl:px-13 lg:px-8 md:px-6 px-3">
                    <div
                        class="md:w-1/4 sm:w-1/3 w-1/2 h-full bg-[var(--card-background)] rounded-md flex flex-col sm:gap-2 gap-1 items-center justify-between sm:p-1 p-0.5 cart_shadow">
                        <div class="w-full h-7/12">
                        ...
                        <div class="w-full h-5/12 flex flex-col lg:gap-3 gap-2 justify-start items-center">
                            <h3
                                class="xl:w-10/12 w-11/12 max-xl:text-sm max-lg:text-xs max-sm:text-[10px] text-[var(--dark-text)] text-center font-bold">
                                راهنمای کامل سئو برای کسب و کار های محلی</h3>
                            <span
                                class="xl:text-sm lg:text-xs sm:text-[11px] text-[8px] text-[var(--secondary-text)]">18فروردین
                                1403</span>
                        </div>
                    </div>
                    <div
                    ...
                    <div
                        class="md:w-1/4 sm:w-1/3 w-1/2 h-full bg-[var(--card-background)] rounded-md flex flex-col sm:gap-2 gap-1 items-center justify-between sm:p-1 p-0.5 cart_shadow max-sm:hidden">
                        <div class="w-full h-7/12">
                            <img src="{{asset('storage/home/article4.jpg')}}" alt=""
                                class="object-fit w-full h-full rounded-t-2xl rounded-b-sm">
                        </div>
                    ...
                    <div
                        class="md:w-1/4 sm:w-1/3 w-1/2 h-full bg-[var(--card-background)] rounded-md flex flex-col sm:gap-2 gap-1 items-center justify-between sm:p-1 p-0.5 cart_shadow max-md:hidden">
                        <div class="w-full h-7/12">
                            <img src="{{asset('storage/home/article4.jpg')}}" alt=""
                                class="object-fit w-full h-full rounded-t-2xl rounded-b-sm">
                        </div>
        ...
        <section class="w-full flex items-center justify-center">
            <div class="w-11/12 flex gap-8 items-start bg-red-500 justify-start section_shadow py-5 lg:px-10 md:px-5 px-2 rounded-xl "
                ...
                <div class="lg:w-10/12 w-full flex flex-col gap-4 justify-start items-center">
                    ...
                    <div class="w-full lg:gap-4 gap-2 flex max-sm:flex-col justify-start items-start transition_fast">
                        <div class="sm:w-1/2 w-full h-full flex flex-col gap-1 justify-start items-start">
                            <div
                                ...
                                <div class="w-full px-3 py-3  flex justify-between items-start question_common_onclick">
                                    <span class="max-xl:text-sm max-lg:text-xs max-sm:text-[10px] text-[--dart-text]">چه
                                        فرمت‌هایی برای
                                ...
                                <div
                                    ...
                                    <span class="w-full h-[1px] bg-[var(--secondary-text)]"></span>
                                    <div
                                        ...
                                        <p
                                            class="max-xl:text-sm max-lg:text-xs max-sm:text-[10px] text-[var(--secondary-text)] text-justify leading-6">
    ...
    <footer class="mt-20 flex flex-col gap-20 justify-start items-center">
                ...
                <div class="lg:w-3/12 w-full flex">
                    <div
                        ...
                        <div class="lg:w-10/12 w-11/12 flex flex-col lg:gap-6 gap-4 justify-start items-start ">
                            ...
                            <p
                                class="w-full xl:text-sm lg:text-xs text-[11px] font-bold text-[#f4f1ff] max-lg:text-center text-justify">
